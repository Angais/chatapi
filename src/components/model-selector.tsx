...
import { ImageAspectRatioSelector } from "./image-aspect-ratio-selector";
...
export function ModelSelector() {
  ...
  const handleModelChange = (value: string) => {
    ...
    const wasRealtimeModel = REALTIME_MODELS.some(
      (m) => m.id === previousModel
    );
